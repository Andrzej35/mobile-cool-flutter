...
#ifndef COOL_MOBILE_APP_SWIFT_H
#define COOL_MOBILE_APP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="cool_mobile_app",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC15cool_mobile_app11AppDelegate")
...
SWIFT_CLASS("_TtC15cool_mobile_app17MainFlutterWindow")
